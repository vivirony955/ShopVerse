...
export class ProductsController {
  ...
  @Get(':id/related')
  getRelated(@Param('id', ParseIntPipe) id: number, @Query('limit') limit = 8) {
  ...
  @Get(':id/upsells')
  getUpsells(@Param('id', ParseIntPipe) id: number, @Query('limit') limit = 4) {
  ...
  notifyBackInStock(
    ...
    return this.productsService.subscribeStockNotification(
      variantId,
      body.email,
      body.phone,
    );
