...
// The W6.T3 PluginLoader bootstrap gap was closed by
// PluginBootstrapService (backend/src/common/plugin-bootstrap.service.ts)
// which seeds the loader from the manifest at OnApplicationBootstrap.
// All tests below now run against a populated loader.
